...
\definecolor{matlabfunc}{rgb}{0.0, 0.5, 0.0}     % Màu xanh lá cho hàm matlab
\definecolor{matlabvar}{rgb}{0.75, 0.1, 0.1}     % Màu đỏ sẫm cho biến matlab
...
\lstdefinestyle{matlabstyle}{
    style=mystyle,
    language=Matlab,
    % Nhóm 1: Các hàm hệ thống của MATLAB -> Màu matlabfunc
    classoffset=1,
    morekeywords={audioread, reshape, svd, figure, uipanel, subplot, plot, title, grid, guidata, uicontrol, audioplayer, play, stop, audiowrite, msgbox, errordlg, str2double, isnan, round, get, axes},
    keywordstyle=\color{matlabfunc}\bfseries,
    % Nhóm 2: Các biến quan trọng đặc thù của bài toán -> Màu matlabvar
    classoffset=2,
    morekeywords={U, S, V, A, y, y1, Fs, k},
    keywordstyle=\color{matlabvar}\bfseries,
    classoffset=0 % Reset về mặc định
}
